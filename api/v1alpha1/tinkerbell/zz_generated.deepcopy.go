...
func (in *MetadataInstance) DeepCopyInto(out *MetadataInstance) {
	*out = *in
	...
	if in.Network != nil {
		...
		*out = new(MetadataInstanceNetwork)
		(*in).DeepCopyInto(*out)
	}
	if in.Console != nil {
		in, out := &in.Console, &out.Console
		*out = new(MetadataInstanceConsole)
		**out = **in
	}
	if in.Users != nil {
		in, out := &in.Users, &out.Users
		*out = make([]*MetadataInstanceUser, len(*in))
		for i := range *in {
			if (*in)[i] != nil {
				in, out := &(*in)[i], &(*out)[i]
				*out = new(MetadataInstanceUser)
				(*in).DeepCopyInto(*out)
			}
		}
	}
	if in.SSHD != nil {
		in, out := &in.SSHD, &out.SSHD
		*out = new(MetadataInstanceSSHD)
		(*in).DeepCopyInto(*out)
	}
}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *MetadataInstanceConsole) DeepCopyInto(out *MetadataInstanceConsole) {
	*out = *in
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new MetadataInstanceConsole.
func (in *MetadataInstanceConsole) DeepCopy() *MetadataInstanceConsole {
	if in == nil {
		return nil
	}
	out := new(MetadataInstanceConsole)
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *MetadataInstanceNetwork) DeepCopyInto(out *MetadataInstanceNetwork) {
	*out = *in
	if in.Interfaces != nil {
		in, out := &in.Interfaces, &out.Interfaces
		*out = new(MetadataInstanceNetworkInterfaces)
		(*in).DeepCopyInto(*out)
	}
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new MetadataInstanceNetwork.
func (in *MetadataInstanceNetwork) DeepCopy() *MetadataInstanceNetwork {
	if in == nil {
		return nil
	}
	out := new(MetadataInstanceNetwork)
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *MetadataInstanceNetworkInterface) DeepCopyInto(out *MetadataInstanceNetworkInterface) {
	*out = *in
	...
	if in.LocalHostname != nil {
		in, out := &in.LocalHostname, &out.LocalHostname
		*out = new(string)
		**out = **in
	}
	if in.LocalIPv4s != nil {
		in, out := &in.LocalIPv4s, &out.LocalIPv4s
		*out = make([]string, len(*in))
		copy(*out, *in)
	}
	if in.Mac != nil {
	...
	if in.PublicHostname != nil {
		in, out := &in.PublicHostname, &out.PublicHostname
		*out = new(string)
		**out = **in
	}
	if in.PublicIPv4s != nil {
		in, out := &in.PublicIPv4s, &out.PublicIPv4s
		*out = make([]string, len(*in))
		copy(*out, *in)
	}
	if in.SubnetIPv4CidrBlock != nil {
		in, out := &in.SubnetIPv4CidrBlock, &out.SubnetIPv4CidrBlock
		*out = new(string)
		**out = **in
	}
	if in.VpcIPv4CidrBlocks != nil {
		in, out := &in.VpcIPv4CidrBlocks, &out.VpcIPv4CidrBlocks
		*out = make([]string, len(*in))
		copy(*out, *in)
	}
	if in.IPv6s != nil {
		in, out := &in.IPv6s, &out.IPv6s
		*out = make([]string, len(*in))
		copy(*out, *in)
	}
	if in.SubnetIPv6CidrBlocks != nil {
		in, out := &in.SubnetIPv6CidrBlocks, &out.SubnetIPv6CidrBlocks
		*out = make([]string, len(*in))
		copy(*out, *in)
	}
	if in.VpcIPv6CidrBlocks != nil {
		in, out := &in.VpcIPv6CidrBlocks, &out.VpcIPv6CidrBlocks
		*out = make([]string, len(*in))
		copy(*out, *in)
	}
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new MetadataInstanceNetworkInterface.
func (in *MetadataInstanceNetworkInterface) DeepCopy() *MetadataInstanceNetworkInterface {
	if in == nil {
		return nil
	}
	out := new(MetadataInstanceNetworkInterface)
	in.DeepCopyInto(out)
	return out
}

// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *MetadataInstanceNetworkInterfaces) DeepCopyInto(out *MetadataInstanceNetworkInterfaces) {
	*out = *in
	if in.Macs != nil {
		in, out := &in.Macs, &out.Macs
		*out = make(map[string]*MetadataInstanceNetworkInterface, len(*in))
		for key, val := range *in {
			var outVal *MetadataInstanceNetworkInterface
			if val == nil {
				(*out)[key] = nil
			} else {
				inVal := (*in)[key]
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new MetadataInstanceNetworkInterfaces.
func (in *MetadataInstanceNetworkInterfaces) DeepCopy() *MetadataInstanceNetworkInterfaces {
	if in == nil {
		return nil
	}
	out := new(MetadataInstanceNetworkInterfaces)
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *MetadataInstanceSSHD) DeepCopyInto(out *MetadataInstanceSSHD) {
	*out = *in
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new MetadataInstanceSSHD.
func (in *MetadataInstanceSSHD) DeepCopy() *MetadataInstanceSSHD {
	if in == nil {
		return nil
	}
	out := new(MetadataInstanceSSHD)
...
func (in *MetadataInstanceStorage) DeepCopyInto(out *MetadataInstanceStorage) {
	*out = *in
	...
	if in.VolumeGroups != nil {
		...
		*out = make([]*MetadataInstanceStorageVolumeGroup, len(*in))
		for i := range *in {
			if (*in)[i] != nil {
				in, out := &(*in)[i], &(*out)[i]
				*out = new(MetadataInstanceStorageVolumeGroup)
				(*in).DeepCopyInto(*out)
			}
		}
	}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *MetadataInstanceStorageLogicalVolume) DeepCopyInto(out *MetadataInstanceStorageLogicalVolume) {
	*out = *in
	if in.Tags != nil {
		in, out := &in.Tags, &out.Tags
		*out = make([]string, len(*in))
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new MetadataInstanceStorageLogicalVolume.
func (in *MetadataInstanceStorageLogicalVolume) DeepCopy() *MetadataInstanceStorageLogicalVolume {
	if in == nil {
		return nil
	}
	out := new(MetadataInstanceStorageLogicalVolume)
	in.DeepCopyInto(out)
	return out
}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *MetadataInstanceStorageVolumeGroup) DeepCopyInto(out *MetadataInstanceStorageVolumeGroup) {
	*out = *in
	...
	if in.LogicalVolumes != nil {
		...
		*out = make([]*MetadataInstanceStorageLogicalVolume, len(*in))
		for i := range *in {
			if (*in)[i] != nil {
				in, out := &(*in)[i], &(*out)[i]
				*out = new(MetadataInstanceStorageLogicalVolume)
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new MetadataInstanceStorageVolumeGroup.
func (in *MetadataInstanceStorageVolumeGroup) DeepCopy() *MetadataInstanceStorageVolumeGroup {
	if in == nil {
		return nil
	}
	out := new(MetadataInstanceStorageVolumeGroup)
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *MetadataInstanceUser) DeepCopyInto(out *MetadataInstanceUser) {
	*out = *in
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new MetadataInstanceUser.
func (in *MetadataInstanceUser) DeepCopy() *MetadataInstanceUser {
	if in == nil {
		return nil
	}
	out := new(MetadataInstanceUser)
